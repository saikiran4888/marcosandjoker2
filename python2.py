...
async def test(ctx):
    ...
    embed.add_field(name="** \n \n Well, If you broke any rules above, You'll get warning or Instant/Ban based on how severe your actions are... And the punishments decided by staff are as follows...**", value=punishments, inline=False)
